...
using static Voice_Bot.MessagesController;
...
namespace Voice_Bot
{
	public class BingSpeech
	{
		...
		public string SubscriptionKey { get; } = "3423bb08-f6f6-4e3e-a85e-a23ed2a7f763";
				...
				.Container.BeginLifetimeScope(DialogModule.LifetimeScopeTag, Configure))
			{
				scope.Resolve<IMessageActivity>
					(TypedParameter.From((IMessageActivity)activity));
					 DialogModule_MakeRoot.Register(scope, () => new Dialogs.ICTLuisDialog());
